...
void cc_Tx_INIT() {
    ...
    halRfWriteReg(IOCFG3,0x06);          //GPIO3 IO Pin Configuration
    halRfWriteReg(IOCFG2,0x07);          //GPIO2 IO Pin Configuration
    halRfWriteReg(IOCFG1,0x30);          //GPIO1 IO Pin Configuration
    halRfWriteReg(IOCFG0,0x3C);          //GPIO0 IO Pin Configuration
    ...
    halRfWriteReg(SYNC_CFG1,0x0A);       //Sync Word Detection Configuration Reg. 1
    ...
    halRfWriteReg(PREAMBLE_CFG1,0x14);   //Preamble Length Configuration Reg. 1
    ...
    halRfWriteReg(MDMCFG0,0x0D);         //General Modem Parameter Configuration Reg. 0
    ...
    halRfWriteReg(AGC_CS_THR,0x00);      //Carrier Sense Threshold Configuration
    ...
    halRfWriteReg(AGC_CFG1,0xAA);        //Automatic Gain Control Configuration Reg. 1
    halRfWriteReg(AGC_CFG0,0xC3);        //Automatic Gain Control Configuration Reg. 0
    halRfWriteReg(FIFO_CFG,0x80);        //FIFO Configuration
    ...
    halRfWriteReg(FS_CFG,0x04);          //Frequency Synthesizer Configuration
